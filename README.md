...
DEPRECATED. Support for this model continues as part of the [AGBNP OpenMM plugin](https://github.com/egallicc/openmm_agbnp_plugin). Please refer to the AGBNP project for production work. 
